...
for module_keys in module_keys:
    lista.append(module_keys)
...
Output_Logic.append("module"+str(",".join(lista))+"("+inputs["name"][0]+","+inputs["name"][1]+","+inputs["name"][2]+","+outputs["name"][0]+");")
